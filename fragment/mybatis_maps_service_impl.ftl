    ...
    @Override
    public List<${xxxx}${name}${r"PageVO>"} find${xxxx}Page(PageDTO page,${xxxx}${name}PageDTO params) {
    ...
    <#else>
    @Override
    public List${r"<Map<String, Object>>"} find${xxxx}Page(PageDTO page, ${xxxx}${name}PageDTO params) {
